...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['edit'])) {
        ...
        header("Location: editStudent.php?id=$courseIdToEdit");
        exit();
    }
...
?>
            ...
            <!-- End Sidebar -->
            <div class="container tableContainer" style="width: 70vw; padding-left:20px;">
                ...
                <div class="d-flex justify-content-end" style="position: sticky; bottom: 3%;">
                    <a href="addstudent.php" class="btn btn-danger btn-lg">+</a>
                </div>
            </div>
