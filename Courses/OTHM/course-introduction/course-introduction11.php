...
<div style="width: 70vw;">
    <img src="image/introduction-11.png" alt="" style="width:70vw;">
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        <a href="course-introduction10.php"><button class="btn btn-primary">Previous</button></a>
        <a href="../../OTHM\course-specification\1.php"><button class="btn btn-success">Course Introduction Completed</button></a>
    </div>
</div>
