...
<div style="width: 70vw;">
    <img src="image/introduction-3.png" alt="" style="width:70vw;">
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        <a href="course-introduction.php"><button class="btn btn-primary">Previous</button></a>
        <a href="course-introduction3.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
