...
<div>
    <h2>Further Progression</h2>
</div>
<div style="width: 70vw;">
    <img src="image/introduction-10.png" alt="" style="width:70vw;">
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        <a href="course-introduction9.php"><button class="btn btn-primary">Previous</button></a>
        <a href="course-introduction11.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
