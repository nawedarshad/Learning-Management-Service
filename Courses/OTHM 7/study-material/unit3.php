...
<div style="width: 70vw;">
    ...
    <div id="pdfViewer">
    <iframe src="http://docs.google.com/gview?url=https://safeplusacademy.com/LMS/Files/UNIT%203%20-%20OTHM%20LEVEL%206%20DIPLOMA%20IN%20OCCUPATIONAL%20HEALTH%20%26%20SAFETY.pdf&embedded=true" style="width:70vw; height:500px;" frameborder="0"></iframe>
</div>

    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        <a href="unit2.php"><button class="btn btn-primary">Previous</button></a>
        <a href="unit4.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
