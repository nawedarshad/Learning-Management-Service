...
if (!isset($_SESSION["isLogin2"])) {
    header("Location: ../../login-oil-and-gas.php");
    exit();
}
?>
...
<div style="width: 70vw;">
    ...
    <div id="pdfViewer">
    <iframe src="http://docs.google.com/gview?url=https://safeplusacademy.com/LMS/oil-and-gas-files/oil_and_gas.pdf&embedded=true" style="width:70vw; height:500px;" frameborder="0"></iframe>
</div>
