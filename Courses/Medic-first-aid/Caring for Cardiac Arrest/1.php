...
<div>
    <h2>Caring for Cardiac Arrest</h2>
</div>
<div style="width: 70vw;">
    <!--<img src="image/introduction.png" alt="" style="width:70vw;">-->
    <div id="pdfViewer">
        <video id="myVideo" controls >
  <source src="Video/VTS_15_1 Caring for cardiac arrest.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../Primary Assessment/2.php"><button class="btn btn-primary">Previous</button></a> 
        <a href="../Practice CPR rescue breathe/1.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
