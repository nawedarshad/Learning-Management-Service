...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_01_1 first aid def n intro, first aider reaction.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        ...
        <a href="introduction2.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
