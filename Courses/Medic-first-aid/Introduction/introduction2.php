...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_02_1 first aider PPE_1.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        <a href="introduction.php"><button class="btn btn-primary">Previous</button></a> 
        <a href="introduction3.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
