...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_05_1 emergency response_1.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        <a href="introduction3.php"><button class="btn btn-primary">Previous</button></a> 
        <a href="introduction5.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
