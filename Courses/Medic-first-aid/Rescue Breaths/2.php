...
<div>
    <h2>Rescue Breathing Practice</h2>
</div>
<div style="width: 70vw;">
    <!--<img src="image/introduction.png" alt="" style="width:70vw;">-->
    <div id="pdfViewer">
        <video id="myVideo" controls >
  <source src="Video/VTS_12_1 rescue breathing practice_1.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        ...
        <a href="../AED/1.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
