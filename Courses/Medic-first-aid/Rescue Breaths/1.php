...
<div>
    <h2>Rescue Breathing Tool</h2>
</div>
<div style="width: 70vw;">
    <!--<img src="image/introduction.png" alt="" style="width:70vw;">-->
    <div id="pdfViewer">
        <video id="myVideo" controls >
  <source src="Video/VTS_11_1 rescue  breath training and tools_1.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../CPR-and-AED/1.php"><button class="btn btn-primary">Previous</button></a> 
