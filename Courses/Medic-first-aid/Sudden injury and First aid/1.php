...
<div>
    <h2>Choking and First Aid</h2>
</div>
<div style="width: 70vw;">
    <!--<img src="image/introduction.png" alt="" style="width:70vw;">-->
    <div id="pdfViewer">
        <video id="myVideo" controls >
  <source src="Video/VTS_02_1 Various schenarios and first aid  treatments_1.mp4" type="video/mp4">
</video>

    </div>

    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../Choking and First Aid/1.php"><button class="btn btn-primary">Previous</button></a> 
        <a href="../Sudden Illness and First aid/1.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
