...
<div>
    <h2>Sudden Illness and First aid</h2>
</div>
<div style="width: 70vw;">
    <!--<img src="image/introduction.png" alt="" style="width:70vw;">-->
    <div id="pdfViewer">
        <video id="myVideo" controls >
  <source src="Video/VTS_02_3 Various schenarios and first aid  treatments_1.mp4" type="video/mp4">
</video>

    </div>

    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../Sudden injury and First aid/1.php"><button class="btn btn-primary">Previous</button></a> 
