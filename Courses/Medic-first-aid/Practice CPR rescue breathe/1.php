...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_16_1 primary response practice with trainer_1.mp4" type="video/mp4">
</video>

    </div>

    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../Caring for Cardiac Arrest/1.php"><button class="btn btn-primary">Previous</button></a> 
