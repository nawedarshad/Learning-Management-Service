...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_14_1 primary response during emergency.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
        ...
        <a href="../Caring for Cardiac Arrest/1.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
