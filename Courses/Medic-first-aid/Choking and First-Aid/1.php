...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_23_1 choking airway_1.mp4" type="video/mp4">
</video>

    </div>

    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../Practice CPR rescue breathe/4.php"><button class="btn btn-primary">Previous</button></a> 
        <a href="../Sudden injury and First aid/1.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
