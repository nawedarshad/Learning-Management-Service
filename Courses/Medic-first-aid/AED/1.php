...
<div style="width: 70vw;">
  ...
  <source src="Video/VTS_13_1 AED intro and usage_1.mp4" type="video/mp4">
</video>
    ...
    <div class="py-3 d-flex justify-content-center" style="gap: 20px;">
         <a href="../Rescue Breaths/2.php"><button class="btn btn-primary">Previous</button></a> 
        <a href="../Primary Assessment/1.php"><button class="btn btn-success">Next</button></a>
    </div>
</div>
